...
struct PlayingCardDeck {
    public typealias cardsState = (wasSelected: Bool, isSet: Bool?, selectedCards: [Int]?)
  ...
  mutating func selectedCard(WithIdentifire identifire: Int, closure: (cardsState) -> Void) {
